...
namespace CryptoToolkitUnitTests.SymKey
{
    public class Salsa20Tests
    {
        ...
        {
            using (FileStream fsDat = StreamHelper.GetFileStreamOpen(@"data\SymKey\salsa20_data.dat"))
            {
                using (FileStream fsEnc = StreamHelper.GetFileStreamOpen(@"data\SymKey\salsa20_enc.dat"))
                {
