...
namespace CryptoToolkitUnitTests.SymKey
{
    public class DESTests
    {
        ...
        {
            using (FileStream fsDat = StreamHelper.GetFileStreamOpen(@"data\SymKey\des_data.dat"))
            {
                using (FileStream fsEnc = StreamHelper.GetFileStreamOpen(@"data\SymKey\des_enc.dat"))
                {
