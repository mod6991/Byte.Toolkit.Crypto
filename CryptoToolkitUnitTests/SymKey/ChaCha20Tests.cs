...
namespace CryptoToolkitUnitTests.SymKey
{
    public class ChaCha20Tests
    {
        ...
        {
            using (FileStream fsDat = StreamHelper.GetFileStreamOpen(@"data\SymKey\chacha20_data.dat"))
            {
                using (FileStream fsEnc = StreamHelper.GetFileStreamOpen(@"data\SymKey\chacha20_enc.dat"))
                {
